package dev.interview.jholkin.franchises.application.services;

import dev.interview.jholkin.franchises.application.ports.input.FranchiseServicePort;
import dev.interview.jholkin.franchises.application.ports.output.FranchisePersistencePort;
